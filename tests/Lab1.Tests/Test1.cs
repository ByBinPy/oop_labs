...
public class Test1
{
    ...
    {
        yield return new object[] { new Collection<RouteCut> { new RouteCut(new NeutrinoPerticleNebula(new Collection<IObstacle> { new CosmoWhale() }), 200), new RouteCut(new Space(new Collection<IObstacle> { new Asteroid(), new Asteroid(), new Asteroid(), new Asteroid(), new Meteor(), new Meteor() })), new RouteCut(new HighDensityNebula(new Collection<IObstacle> { new AntimaterFlare() }), 500) }, new Vaclas(new PhotonicDeflector()), new Message(Message.CrashMessage) };
        ...
        yield return new object[] { new Collection<RouteCut> { new RouteCut(new NeutrinoPerticleNebula(new Collection<IObstacle> { new CosmoWhale() }), 200), new RouteCut(new Space(new Collection<IObstacle> { new Asteroid(), new Asteroid(), new Asteroid(), new Asteroid(), new Meteor(), new Meteor() })), new RouteCut(new HighDensityNebula(new Collection<IObstacle> { new AntimaterFlare() }), 500) }, new Stella(new PhotonicDeflector()), new Message(Message.CrashMessage) };
        yield return new object[] { new Collection<RouteCut> { new RouteCut(new NeutrinoPerticleNebula(new Collection<IObstacle> { new CosmoWhale() }), 200), new RouteCut(new Space(new Collection<IObstacle> { new Asteroid(), new Meteor() })), new RouteCut(new HighDensityNebula(new Collection<IObstacle> { new Asteroid() }), 200) }, new Vaclas(), new Message() };
